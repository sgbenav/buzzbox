...
export const Editor: React.FC<EditorProps> = ({ hiveId }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const { mutate: createPost } = useMutation({
    mutationFn: async ({ title, content, hiveId }: PostCreationRequest) => {
      const payload: PostCreationRequest = { title, content, hiveId }
      const { data } = await axios.post('/api/hive/post/create', payload)
      return data
    },
    onError: () => {
      return toast({
